...
mnist256train = classify._replace(\
  env_name='Classify_mnist256train', input_size=256, i_act=np.full(256,1))
L = [list(range(1, mnist256train.input_size)),\
     list(range(0, mnist256train.output_size))]
label = [item for sublist in L for item in sublist]
mnist256train = mnist256train._replace(in_out_labels=label)
games['mnist256train'] = mnist256train

mnist256test = classify._replace(\
  env_name='Classify_mnist256test', input_size=256, i_act=np.full(256,1))
L = [list(range(1, mnist256test.input_size)),\
     list(range(0, mnist256test.output_size))]
label = [item for sublist in L for item in sublist]
mnist256test = mnist256test._replace(in_out_labels=label)
